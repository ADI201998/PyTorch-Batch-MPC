...
class Config:
    def __init__(self):
        ...
        # Directories
        self._configs["data_dir"]   = "src/LSTR/data"
        self._configs["cache_dir"] = "src/LSTR/cache"

        self._configs["config_dir"] = "src/LSTR/config"
        self._configs["result_dir"] = "src/LSTR/results"
