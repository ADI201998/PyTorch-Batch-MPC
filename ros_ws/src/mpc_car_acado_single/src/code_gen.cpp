...
int main( )
{
	...
	string path ="/home/aditya/Documents/Batch/Batch-Opt-Highway-Driving/ros_ws/src/mpc_car_acado_single";
	// Variables:

	double lx = 4.9/2, ly = 2.625/2;
...
// 	mpc.set( HOTSTART_QP,                 YES             );
	...
	if (mpc.exportCode( "/home/aditya/Documents/Batch/Batch-Opt-Highway-Driving/ros_ws/src/mpc_car_acado_single/model/codegen" ) != SUCCESSFUL_RETURN)
